...
public class GerenteRRHH extends EncargadoEmpleado {
    ...
    public void procesarExcusaTrivial(Excusa excusa) {
        throw new UnsupportedOperationException("Gerente no puede procesar excusas triviales");
    }

    @Override
    public void procesarExcusaModerada(Excusa excusa) {
        throw new UnsupportedOperationException("Gerente no puede procesar excusas moderadas");
    }
    ...
    public void procesarExcusaCompleja(Excusa excusa) {
        ...
        System.out.println("Procesada por Gerente RRHH: " + this.getNombre());
    }

    @Override
    public void procesarExcusaInverosimil(Excusa excusa) {
        throw new UnsupportedOperationException("Gerente no puede procesar excusas inverosímiles");
    }
}
